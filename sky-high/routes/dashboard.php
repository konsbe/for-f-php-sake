...
<body>
  ...
  ?>
    ...
    //Sql query
    $sql = " select arrival_port, count ( distinct(arrival_port)) from passenger_flight group by arrival_port;";
    $result = pg_query($dbconn, $sql) ;
    //Check results
    if ($result) {
      // var_dump($result);
      echo "<div class='divTable' style='margin-bottom:9rem;'>";
      echo " <h4 style='margin-top:6rem;margin-bottom: 3rem;'>Top Destinations</h4>";
